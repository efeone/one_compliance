...
fixtures = [{'dt': 'Role', 'filters': [['name', 'in', ['Director','Compliance Manager','Senior Manager','Manager','Executive','Head Of Department']]]},
            ...
            {'dt': 'Customer Type'},
            {'dt': 'Workflow State', 'filters': [['name', 'in', ['Draft','Approved','Rejected','Pending','Sent to Customer','Customer Approval Waiting','Customer Approved','Customer Rejected','Cancelled']]]},
			{'dt': 'Workflow', 'filters': [['name', 'in', ['Compliance Agreement Workflow']]]},
			{'dt': 'Workflow Action Master', 'filters': [['name', 'in', ['Rejected','Approved','Request for Review','Review','Reject','Approve','Sent to Customer','Customer Approval','Customer Reject','Customer Approval waiting','Cancelled']]]},
            ...
            {'dt': 'Role Profile','filters':[['name','in',['Director','Super Admin','Head Of Department','Senior Manager','Manager','Executive']]]},
