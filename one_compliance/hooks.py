...
doc_events = {
	...
	'Sales Order':{
		...
		'on_update_after_submit': [
			'one_compliance.one_compliance.doc_events.sales_order.so_on_update_after_submit',
			'one_compliance.one_compliance.doc_events.sales_order.set_invoice_generation_date'
		],
