...
# ],
	"daily": [
        ...
        'one_compliance.one_compliance.utils.daily_notification_for_digital_signature_expiry'
	],
#	"hourly": [
#		"one_compliance.tasks.hourly"
#	],
	"weekly": [
		'one_compliance.one_compliance.utils.weekly_notification_for_digital_signature_expiry'
	],
	"monthly": [
		'one_compliance.one_compliance.utils.monthly_notification_for_digital_signature_expiry'
	],
}
