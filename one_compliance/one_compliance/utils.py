...
def daily_notification_for_digital_signature_expiry():
    ...
    digital_signature = frappe.get_all('Digital Signature', filters= {'notify_before_unit': 'Day'})
...
def weekly_notification_for_digital_signature_expiry():
    ...
    digital_signature = frappe.get_all('Digital Signature', filters= {'notify_before_unit': 'Week'})
    if digital_signature:
        today = getdate(frappe.utils.today())
        notification_date = ''
        for digital_signature_docs in digital_signature:
...
def monthly_notification_for_digital_signature_expiry():
    ...
    digital_signature = frappe.get_all('Digital Signature', filters= {'notify_before_unit': 'Month'})
    if digital_signature:
        today = getdate(frappe.utils.today())
        notification_date = ''
        for digital_signature_docs in digital_signature:
