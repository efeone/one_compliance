...
from frappe.desk.form.assign_to import add as add_assign, format_message_for_assign_to, get, get_title, get_title_html
...
def notify_assignment(assigned_by, allocated_to, doc_type, doc_name, action="CLOSE", description=None, email=True):
	"""
	...
	notification_doc = {
		"type": "Assignment" if email else "Alert",
