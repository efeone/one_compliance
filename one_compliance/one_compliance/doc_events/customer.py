        ...
        if project_template:
            ...
            for legal_authority in doc.custom_legal_authority_list:
                if legal_authority.is_regularised == 0:
                    create_a_director_from_legal_authority(legal_authority.legal_authority, custom_annual_general_meeting_date)
...
@frappe.whitelist()
def create_a_director_from_legal_authority(legal_authority, annual_general_meeting_date):
    if custom_annual_general_meeting_date == today:
